...
export interface CantripDef {
  ...
  range?: string;
  /** Area of effect template, kept separate from `range` ("cầu 20ft", "nón 15ft", "tia 100ft"). */
  area?: string;
  /** Other names the spell goes by (2014 vs 2024 naming) — used by search and PDF import. */
  aliases?: string[];
...
const COMBAT: CantripDef[] = [
  ...
  C('acid-splash', 'Acid Splash', 'Evocation', ['sorcerer', 'wizard'],
    ...
    { combat: true, castKind: 'save', save: 'dex', damageDie: '1d6', damageType: 'acid', range: '60ft', area: 'cầu 5ft (2 mục tiêu)' }),
  ...
  C('word-of-radiance', 'Word of Radiance', 'Evocation', ['cleric'],
    ...
    { combat: true, castKind: 'save', save: 'con', damageDie: '1d6', damageType: 'radiant', range: '5ft', area: 'sinh vật bạn chọn trong 5ft' }),
  ...
  C('thunderclap', 'Thunderclap', 'Evocation', ['bard', 'druid', 'sorcerer', 'warlock', 'wizard'],
    ...
    { combat: true, castKind: 'save', save: 'con', damageDie: '1d6', damageType: 'thunder', range: 'Bản thân', area: 'toả 5ft (trừ bạn)' }),
];
...
const L1: CantripDef[] = [
  ...
  S1('burning-hands', 'Burning Hands', 'Evocation', ['sorcerer', 'wizard'],
    ...
    { combat: true, castKind: 'save', save: 'dex', fixedDamage: '3d6', damageType: 'fire', halfOnSave: true, range: 'Bản thân', area: 'nón 15ft' }),
  S1('thunderwave', 'Thunderwave', 'Evocation', ['bard', 'druid', 'sorcerer', 'wizard'],
    ...
    { combat: true, castKind: 'save', save: 'con', fixedDamage: '2d8', damageType: 'thunder', halfOnSave: true, range: 'Bản thân', area: 'khối 15ft',
  ...
  S1('sleep', 'Sleep', 'Enchantment', ['bard', 'sorcerer', 'wizard'],
    ...
    { combat: true, castKind: 'save', save: 'wis', range: '90ft', area: 'cầu 5ft',
  ...
  S1('faerie-fire', 'Faerie Fire', 'Evocation', ['bard', 'druid'],
    ...
    { combat: true, castKind: 'save', save: 'dex', concentration: true, range: '60ft', area: 'khối 20ft',
  ...
  S1('arms-of-hadar', 'Arms of Hadar', 'Conjuration', ['warlock'],
    ...
    { combat: true, castKind: 'save', save: 'str', fixedDamage: '2d6', damageType: 'necrotic', halfOnSave: true, range: 'Bản thân', area: 'toả 10ft' }),
  S1('color-spray', 'Color Spray', 'Illusion', ['bard', 'sorcerer', 'wizard'],
    ...
    { combat: true, castKind: 'utility', range: 'Bản thân', area: 'nón 15ft',
  ...
  S1('entangle', 'Entangle', 'Conjuration', ['druid'],
    ...
    { combat: true, castKind: 'save', save: 'str', concentration: true, range: '90ft', area: 'ô vuông 20ft',
  ...
  S1('grease', 'Grease', 'Conjuration', ['sorcerer', 'wizard'],
    ...
    { combat: true, castKind: 'save', save: 'dex', range: '60ft', area: 'ô vuông 10ft',
  ...
  S1('alarm', 'Alarm', 'Abjuration', ['ranger', 'wizard'],
    ...
    { range: '30ft', area: 'khối 20ft' }),
  S1('animal-friendship', 'Animal Friendship', 'Enchantment', ['bard', 'druid', 'ranger'],
    'Tầm 30ft, 1 Beast thấy được, save WIS, 24 giờ. Fail → Bị mê hoặc (Charmed); kết thúc nếu bạn hoặc đồng minh gây sát thương cho nó. Nâng ô: +1 Beast.',
    { combat: true, castKind: 'save', save: 'wis', range: '30ft',
      effect: { name: 'Animal Friendship (Charmed)', condition: 'charmed', note: 'Hết khi bị gây sát thương' } }),
  S1('comprehend-languages', 'Comprehend Languages', 'Divination', ['bard', 'sorcerer', 'warlock', 'wizard'],
    'Bản thân, 1 giờ (Ritual). Hiểu nghĩa đen mọi ngôn ngữ nghe/thấy; hiểu chữ viết nếu chạm vào (≈1 phút/trang). Không giải mã ký hiệu bí mật.',
    { range: 'Bản thân' }),
  S1('create-or-destroy-water', 'Create or Destroy Water', 'Transmutation', ['cleric', 'druid'],
    'Tầm 30ft. Tạo tới 10 gallon nước sạch (hoặc mưa trong khối 30ft dập lửa), hoặc hủy 10 gallon nước / xua sương trong khối 30ft. Nâng ô: +10 gallon, +5ft khối.',
    { range: '30ft', area: 'khối 30ft' }),
  S1('detect-evil-and-good', 'Detect Evil and Good', 'Divination', ['cleric', 'paladin'],
    'Bản thân, tập trung 10 phút. Cảm nhận vị trí Aberration/Celestial/Elemental/Fey/Fiend/Undead trong 30ft, và Hallow. Bị chặn bởi 1ft đá/đất/gỗ, 1 inch kim loại.',
    { concentration: true, range: 'Bản thân' }),
  S1('detect-poison-and-disease', 'Detect Poison and Disease', 'Divination', ['cleric', 'druid', 'paladin', 'ranger'],
    'Bản thân, tập trung 10 phút (Ritual được). Cảm nhận độc, sinh vật độc và bệnh phép trong 30ft, biết loại nào. Bị chặn như Detect Evil and Good.',
    { concentration: true, range: 'Bản thân' }),
  S1('dissonant-whispers', 'Dissonant Whispers', 'Enchantment', ['bard'],
    'Tầm 60ft, save WIS. Fail → 3d6 tâm linh và phải dùng Reaction chạy xa khỏi bạn hết mức; thành công → nửa sát thương, không phải chạy. Nâng ô: +1d6.',
    { combat: true, castKind: 'save', save: 'wis', fixedDamage: '3d6', damageType: 'psychic', halfOnSave: true, range: '60ft' }),
  S1('divine-smite', 'Divine Smite', 'Evocation', ['paladin'],
    'Bonus action ngay sau khi trúng đòn cận chiến / tay không. Mục tiêu nhận thêm 2d8 radiant (+1d8 nếu Fiend/Undead). Nâng ô: +1d8 mỗi cấp. App: bấm để trừ damage lên mục tiêu.',
    { combat: true, castKind: 'damage', fixedDamage: '2d8', damageType: 'radiant', actionType: 'bonus', range: 'Bản thân' }),
  S1('ensnaring-strike', 'Ensnaring Strike', 'Conjuration', ['ranger'],
    'Bonus action ngay sau khi trúng đòn vũ khí, tập trung 1 phút. Mục tiêu save STR (Large+ có lợi thế). Fail → Bị trói (Restrained), 1d6 xuyên đầu mỗi lượt; nó hoặc người trong tầm với dùng Action check STR (Athletics) vs DC phép để phá. Thành công save → phép hết. Nâng ô: +1d6.',
    { combat: true, castKind: 'save', save: 'str', concentration: true, actionType: 'bonus', range: 'Bản thân',
      effect: { name: 'Ensnaring Strike (Restrained)', condition: 'restrained', note: '1d6 xuyên đầu mỗi lượt; Action Athletics vs DC phép để thoát' } }),
  S1('expeditious-retreat', 'Expeditious Retreat', 'Transmutation', ['sorcerer', 'warlock', 'wizard'],
  ...
  S1('floating-disk', 'Floating Disk', 'Conjuration', ['wizard'],
    ...
    { range: '30ft' }),
  S1('fog-cloud', 'Fog Cloud', 'Conjuration', ['druid', 'ranger', 'sorcerer', 'wizard'],
    'Tầm 120ft, tập trung 1 giờ. Tạo cầu sương bán kính 20ft, Heavily Obscured; gió mạnh (Gust of Wind) xua tan. Nâng ô: +20ft bán kính.',
    { concentration: true, range: '120ft', area: 'cầu 20ft' }),
  S1('ice-knife', 'Ice Knife', 'Conjuration', ['druid', 'sorcerer', 'wizard'],
    'Tầm 60ft. Đòn đánh phép: trúng 1d10 xuyên. Trúng hay trượt, mảnh băng nổ: mục tiêu + mọi sinh vật trong 5ft save DEX, fail 2d6 lạnh. App: chỉ tự động phần đòn đánh; nổ băng dùng vùng/save tay. Nâng ô: +1d6 lạnh.',
    { combat: true, castKind: 'attack', fixedDamage: '1d10', damageType: 'piercing', range: '60ft', area: 'cầu 5ft (nổ)' }),
  S1('identify', 'Identify', 'Divination', ['bard', 'wizard'],
    'Chạm, đúc 1 phút (Ritual). Biết tính chất, cách dùng, có cần attune không, số charge của 1 vật ma thuật, và phép đang ảnh hưởng; hoặc biết phép nào đang tác động lên 1 sinh vật.',
    { range: 'Chạm' }),
  S1('illusory-script', 'Illusory Script', 'Illusion', ['bard', 'warlock', 'wizard'],
    'Chạm, đúc 1 phút (Ritual), 10 ngày. Viết chữ ảo: chỉ bạn và người bạn chọn đọc được nghĩa thật; người khác thấy chữ lạ / nội dung giả. Dispel Magic mới xóa được.',
    { range: 'Chạm' }),
  S1('purify-food-and-drink', 'Purify Food and Drink', 'Transmutation', ['cleric', 'druid', 'paladin'],
    'Tầm 10ft (Ritual). Loại độc và thối khỏi đồ ăn thức uống thường trong cầu 5ft.',
    { range: '10ft', area: 'cầu 5ft' }),
  S1('searing-smite', 'Searing Smite', 'Evocation', ['paladin'],
    'Bonus action ngay sau khi trúng đòn cận chiến, tập trung 1 phút. +1d6 lửa; đầu mỗi lượt mục tiêu chịu 1d6 lửa rồi save CON — fail thì phép tiếp tục, thành công thì hết. Nâng ô: +1d6 cho mọi sát thương.',
    { combat: true, castKind: 'damage', fixedDamage: '1d6', damageType: 'fire', concentration: true, actionType: 'bonus', range: 'Bản thân' }),
  S1('unseen-servant', 'Unseen Servant', 'Conjuration', ['bard', 'warlock', 'wizard'],
    'Tầm 60ft, 1 giờ (Ritual). Lực vô hình, vô tri làm việc vặt theo lệnh (Bonus Action ra lệnh, tầm 60ft). AC 10, 1 HP, không tấn công.',
    { range: '60ft' }),
];
...
const L2: CantripDef[] = [
  ...
  S2('cloud-of-daggers', 'Cloud of Daggers', 'Conjuration', ['bard', 'sorcerer', 'warlock', 'wizard'],
    ...
    { combat: true, castKind: 'damage', fixedDamage: '4d4', damageType: 'slashing', concentration: true, range: '60ft', area: 'khối 5ft' }),
  ...
  S2('shatter', 'Shatter', 'Evocation', ['bard', 'sorcerer', 'warlock', 'wizard'],
    ...
    { combat: true, castKind: 'save', save: 'con', fixedDamage: '3d8', damageType: 'thunder', halfOnSave: true, range: '60ft', area: 'cầu 10ft' }),
  S2('moonbeam', 'Moonbeam', 'Evocation', ['druid'],
    ...
    { combat: true, castKind: 'save', save: 'con', fixedDamage: '2d10', damageType: 'radiant', halfOnSave: true, concentration: true, range: '120ft', area: 'trụ tròn bán kính 5ft, cao 40ft' }),
  S2('flaming-sphere', 'Flaming Sphere', 'Conjuration', ['druid', 'wizard'],
    ...
    { combat: true, castKind: 'save', save: 'dex', fixedDamage: '2d6', damageType: 'fire', halfOnSave: true, concentration: true, range: '60ft', area: 'cầu đường kính 5ft (di chuyển được)' }),
  ...
  S2('darkness', 'Darkness', 'Evocation', ['sorcerer', 'warlock', 'wizard'],
    ...
    { concentration: true, range: '60ft', area: 'cầu 15ft' }),
  ...
  S2('calm-emotions', 'Calm Emotions', 'Enchantment', ['bard', 'cleric'],
    ...
    { concentration: true, range: '60ft', area: 'cầu 20ft' }),
  ...
  S2('warding-bond', 'Warding Bond', 'Abjuration', ['cleric'],
    ...
    { range: 'Chạm' }),
  // --- SRD completion: remaining level-2 spells ---
  S2('alter-self', 'Alter Self', 'Transmutation', ['sorcerer', 'wizard'],
    'Bản thân, tập trung 1 giờ. Chọn 1 dạng (đổi bằng Magic action): Aquatic Adaptation (thở dưới nước, bơi tốc độ), Change Appearance, hoặc Natural Weapons (đòn tay không 1d6 + mod, dùng chỉ số ra phép).',
    { concentration: true, range: 'Bản thân' }),
  S2('animal-messenger', 'Animal Messenger', 'Enchantment', ['bard', 'druid', 'ranger'],
    'Tầm 30ft (Ritual), 24 giờ. Tiny Beast (CR 0 tự động đồng ý) mang tin ≤ 25 từ tới người/nơi bạn mô tả, cách xa tới số dặm đi trong thời gian phép.',
    { range: '30ft' }),
  S2('arcane-lock', 'Arcane Lock', 'Abjuration', ['wizard'],
    'Chạm, vĩnh viễn tới khi giải. Khóa cửa/rương bằng phép: bạn và người bạn chỉ định mở được; người khác cần phép Knock/Dispel hoặc phá (DC tăng thêm 10).',
    { range: 'Chạm' }),
  S2('arcanists-magic-aura', "Arcanist's Magic Aura", 'Illusion', ['wizard'],
    'Chạm, 24 giờ. Che dấu hiệu ma thuật: giả thành vật thường / đổi trường phái hiện lên khi Detect Magic; hoặc giấu sinh vật khỏi phép nhận diện.',
    { range: 'Chạm' }),
  S2('augury', 'Augury', 'Divination', ['cleric', 'druid', 'wizard'],
    'Bản thân, đúc 1 phút (Ritual). Nhận điềm cho hành động dự định trong 30 phút tới: Weal (tốt), Woe (xấu), Weal and Woe, hoặc không có gì.',
    { range: 'Bản thân' }),
  ...
  S2('continual-flame', 'Continual Flame', 'Evocation', ['cleric', 'druid', 'wizard'],
    ...
    { range: 'Chạm' }),
  S2('darkvision', 'Darkvision', 'Transmutation', ['druid', 'ranger', 'sorcerer', 'wizard'],
    'Chạm 1 sinh vật tự nguyện, 8 giờ. Nhận Darkvision tầm 150ft.',
    { range: 'Chạm' }),
  S2('dragons-breath', "Dragon's Breath", 'Transmutation', ['sorcerer', 'wizard'],
    'Bonus action, chạm 1 sinh vật tự nguyện, tập trung 1 phút. Chọn Acid/Cold/Fire/Lightning/Poison; nó dùng Magic action thở nón 15ft, save DEX, 3d6 loại đã chọn (nửa nếu thành công). Nâng ô: +1d6.',
    { concentration: true, actionType: 'bonus', range: 'Chạm', area: 'nón 15ft' }),
  S2('enthrall', 'Enthrall', 'Enchantment', ['bard', 'warlock'],
    'Tầm 60ft, tập trung 1 phút. Save WIS (kẻ đang đánh nhau với bạn tự động thắng). Fail → −10 Perception với mọi thứ trừ bạn, và không để ý thứ khác.',
    { combat: true, castKind: 'save', save: 'wis', concentration: true, range: '60ft',
      effect: { name: 'Enthrall (−10 Perception)', note: 'Chỉ chú ý người ra phép' } }),
  S2('find-steed', 'Find Steed', 'Conjuration', ['paladin'],
    'Tầm 30ft. Gọi thú cưỡi (Otherworldly Steed) chiến đấu cùng bạn; bạn nhìn thấy nó cùng nhận phép Bản thân lên nó. Có thể chết/giải tán, gọi lại bằng phép khác.',
    { range: '30ft' }),
  S2('find-traps', 'Find Traps', 'Divination', ['cleric', 'druid', 'ranger'],
    'Tầm 120ft. Cảm nhận mọi bẫy trong tầm nhìn (cơ chế hoặc phép); biết có bẫy nhưng không rõ loại, trừ khi bạn thấy rõ.',
    { range: '120ft' }),
  S2('flame-blade', 'Flame Blade', 'Evocation', ['druid', 'sorcerer'],
    'Bonus action, tập trung 10 phút. Lưỡi lửa trong tay rảnh; Magic action đánh phép cận chiến: trúng 3d6 + chỉ số ra phép lửa. Sáng 10ft + mờ 10ft. Nâng ô: +1d6 mỗi cấp trên 2.',
    { combat: true, castKind: 'attack', fixedDamage: '3d6', damageType: 'fire', addSpellMod: true, concentration: true, actionType: 'bonus', range: 'Chạm' }),
  S2('gentle-repose', 'Gentle Repose', 'Necromancy', ['cleric', 'paladin', 'wizard'],
    'Chạm xác (Ritual), 10 ngày. Xác không thối rữa và không hóa Undead; ngày trôi qua không tính vào thời hạn hồi sinh.',
    { range: 'Chạm' }),
  S2('gust-of-wind', 'Gust of Wind', 'Evocation', ['druid', 'ranger', 'sorcerer', 'wizard'],
    'Bản thân, tập trung 1 phút. Luồng gió dài 60ft rộng 10ft: mỗi sinh vật trong tia save STR, fail bị đẩy 15ft; đi ngược chiều gió tốn gấp đôi; dập lửa nhỏ, xua khí/sương. Đổi hướng bằng Bonus Action.',
    { combat: true, castKind: 'save', save: 'str', concentration: true, range: 'Bản thân', area: 'tia dài 60ft, rộng 10ft',
      effect: { name: 'Gust of Wind (đẩy 15ft)', note: 'Bị đẩy 15ft theo chiều gió', expiresInRounds: 1 } }),
  S2('locate-animals-or-plants', 'Locate Animals or Plants', 'Divination', ['bard', 'druid', 'ranger'],
    'Bản thân (Ritual). Nêu 1 loại thú/thực vật: biết hướng và khoảng cách tới cá thể gần nhất trong 5 dặm.',
    { range: 'Bản thân' }),
  S2('locate-object', 'Locate Object', 'Divination', ['bard', 'cleric', 'druid', 'paladin', 'ranger', 'wizard'],
    'Bản thân, tập trung 10 phút. Mô tả vật quen thuộc: cảm nhận hướng tới nó nếu ≤ 1000ft (chặn bởi chì, không vòng qua được).',
    { concentration: true, range: 'Bản thân' }),
  S2('magic-mouth', 'Magic Mouth', 'Illusion', ['bard', 'wizard'],
    'Tầm 30ft, đúc 1 phút (Ritual). Gắn thông điệp ≤ 25 từ vào vật; nói lên khi điều kiện kích hoạt xảy ra (nhìn/nghe). Tới khi giải.',
    { range: '30ft' }),
  S2('mind-spike', 'Mind Spike', 'Divination', ['sorcerer', 'warlock', 'wizard'],
    'Tầm 120ft, tập trung 1 giờ. Save WIS: fail → 3d8 tâm linh (nửa nếu thành công); fail bạn còn luôn biết vị trí nó suốt phép (cùng cõi), nó không thể ẩn khỏi bạn và Invisible vô hiệu với bạn. Nâng ô: +1d8.',
    { combat: true, castKind: 'save', save: 'wis', fixedDamage: '3d8', damageType: 'psychic', halfOnSave: true, concentration: true, range: '120ft' }),
  S2('phantasmal-force', 'Phantasmal Force', 'Illusion', ['bard', 'sorcerer', 'wizard'],
    'Tầm 60ft, tập trung 1 phút. Save INT: fail → chỉ nó thấy ảo ảnh (tối đa khối 10ft) và tin là thật; nó dùng Study + Investigation vs DC phép để phá. Nếu ảo ảnh là mối nguy, mỗi lượt của bạn nó có thể gây 2d8 tâm linh cho mục tiêu trong hoặc cạnh 5ft.',
    { combat: true, castKind: 'save', save: 'int', concentration: true, range: '60ft',
      effect: { name: 'Phantasmal Force (ảo ảnh)', note: 'Chỉ mục tiêu thấy; ảo ảnh nguy hiểm gây 2d8 tâm linh mỗi lượt của bạn; Study Investigation vs DC để phá' } }),
  S2('protection-from-poison', 'Protection from Poison', 'Abjuration', ['cleric', 'druid', 'paladin', 'ranger'],
    'Chạm, 1 giờ. Chấm dứt Poisoned trên mục tiêu; suốt phép lợi thế save tránh/hết Poisoned và kháng sát thương độc.',
    { range: 'Chạm',
      effect: { name: 'Protection from Poison', note: 'Kháng độc; lợi thế save chống/dứt Poisoned' } }),
  S2('rope-trick', 'Rope Trick', 'Transmutation', ['wizard'],
    'Chạm dây, 1 giờ. Đầu dây treo lơ lửng mở cổng vô hình vào không gian ngoài chiều không gian chứa 8 sinh vật; dây kéo lên được.',
    { range: 'Chạm' }),
  S2('shining-smite', 'Shining Smite', 'Transmutation', ['paladin'],
    'Bonus action ngay sau khi trúng đòn cận chiến, tập trung 1 phút. +2d6 radiant; mục tiêu phát sáng 5ft, không hưởng lợi từ Invisible và đòn đánh vào nó có lợi thế. Nâng ô: +1d6.',
    { combat: true, castKind: 'damage', fixedDamage: '2d6', damageType: 'radiant', concentration: true, actionType: 'bonus', range: 'Bản thân' }),
  S2('spike-growth', 'Spike Growth', 'Transmutation', ['druid', 'ranger'],
    'Tầm 150ft, tập trung 10 phút. Mặt đất cầu 20ft mọc gai: Difficult Terrain; sinh vật di chuyển trong vùng nhận 2d4 xuyên mỗi 5ft đi được. Khó nhận ra. App: tự trừ tay khi token di chuyển.',
    { concentration: true, range: '150ft', area: 'cầu 20ft' }),
];
...
const L3: CantripDef[] = [
  ...
  S3('aura-of-vitality', 'Aura of Vitality', 'Abjuration', ['cleric', 'druid', 'paladin'],
    ...
    { combat: true, castKind: 'heal', heal: '2d6', actionType: 'bonus', concentration: true, range: '30ft', area: '1 mục tiêu / lượt' }),
  ...
  S3('fireball', 'Fireball', 'Evocation', ['sorcerer', 'wizard'],
    ...
    { combat: true, castKind: 'save', save: 'dex', fixedDamage: '8d6', damageType: 'fire', halfOnSave: true, range: '150ft', area: 'cầu 20ft' }),
  S3('lightning-bolt', 'Lightning Bolt', 'Evocation', ['sorcerer', 'wizard'],
    ...
    { combat: true, castKind: 'save', save: 'dex', fixedDamage: '8d6', damageType: 'lightning', halfOnSave: true, range: 'Bản thân', area: 'tia dài 100ft, rộng 5ft' }),
  S3('call-lightning', 'Call Lightning', 'Conjuration', ['druid'],
    ...
    { combat: true, castKind: 'save', save: 'dex', fixedDamage: '3d10', damageType: 'lightning', halfOnSave: true, concentration: true, range: '120ft', area: 'sét đánh: cầu 5ft quanh điểm chọn' }),
  S3('spirit-guardians', 'Spirit Guardians', 'Conjuration', ['cleric'],
    ...
    { combat: true, castKind: 'save', save: 'wis', fixedDamage: '3d8', damageType: 'radiant', halfOnSave: true, concentration: true, range: 'Bản thân', area: 'toả 15ft',
  ...
  S3('conjure-animals', 'Conjure Animals', 'Conjuration', ['druid', 'ranger'],
    ...
    { combat: true, castKind: 'save', save: 'dex', fixedDamage: '3d10', damageType: 'slashing', halfOnSave: true, concentration: true, range: 'Bản thân', area: 'toả 10ft (theo bạn)' }),
  S3('conjure-barrage', 'Conjure Barrage', 'Conjuration', ['ranger'],
    ...
    { combat: true, castKind: 'save', save: 'dex', fixedDamage: '3d8', damageType: 'force', halfOnSave: true, range: 'Bản thân', area: 'nón 60ft' }),
  S3('wind-wall', 'Wind Wall', 'Evocation', ['druid', 'ranger'],
    ...
    { combat: true, castKind: 'save', save: 'str', fixedDamage: '3d8', damageType: 'bludgeoning', halfOnSave: true, concentration: true, range: '120ft', area: 'tường dài 50ft, cao 15ft' }),
  S3('thunder-step', 'Thunder Step', 'Conjuration', ['sorcerer', 'wizard'],
    ...
    { combat: true, castKind: 'save', save: 'con', fixedDamage: '3d10', damageType: 'thunder', halfOnSave: true, range: 'Bản thân', area: 'toả 10ft từ điểm bạn rời đi' }),
  ...
  S3('hunger-of-hadar', 'Hunger of Hadar', 'Conjuration', ['warlock'],
    ...
    { combat: true, castKind: 'damage', fixedDamage: '2d6', damageType: 'cold', concentration: true, range: '150ft', area: 'cầu 20ft',
  ...
  S3('fear', 'Fear', 'Illusion', ['bard', 'sorcerer', 'warlock', 'wizard'],
    ...
    { combat: true, castKind: 'save', save: 'wis', concentration: true, range: 'Bản thân', area: 'nón 30ft',
  ...
  S3('hypnotic-pattern', 'Hypnotic Pattern', 'Illusion', ['bard', 'sorcerer', 'warlock', 'wizard'],
    ...
    { combat: true, castKind: 'save', save: 'wis', concentration: true, range: '120ft', area: 'khối 30ft',
  ...
  S3('slow', 'Slow', 'Transmutation', ['sorcerer', 'wizard'],
    ...
    { combat: true, castKind: 'save', save: 'wis', concentration: true, range: '120ft', area: 'khối 40ft (≤ 6 mục tiêu)',
  ...
  S3('stinking-cloud', 'Stinking Cloud', 'Conjuration', ['bard', 'sorcerer', 'wizard'],
    ...
    { combat: true, castKind: 'save', save: 'con', concentration: true, range: '90ft', area: 'cầu 20ft',
  ...
  S3('crusaders-mantle', "Crusader's Mantle", 'Evocation', ['paladin'],
    ...
    { concentration: true, range: 'Bản thân', area: 'toả 30ft' }),
  ...
  S3('beacon-of-hope', 'Beacon of Hope', 'Abjuration', ['cleric'],
    ...
    { concentration: true, range: '30ft', area: 'nhiều mục tiêu trong tầm' }),
  // --- utility (advisory) ---
  ...
  S3('daylight', 'Daylight', 'Evocation', ['cleric', 'druid', 'paladin', 'ranger', 'sorcerer'],
    ...
    { range: '60ft', area: 'cầu sáng bán kính 60ft' }),
  ...
  S3('magic-circle', 'Magic Circle', 'Abjuration', ['cleric', 'paladin', 'wizard'],
    ...
    { range: '10ft', area: 'trụ tròn bán kính 10ft, cao 20ft' }),
  ...
  S3('plant-growth', 'Plant Growth', 'Transmutation', ['bard', 'druid', 'ranger'],
    ...
    { range: '150ft', area: 'bán kính 100ft (địa hình khó)' }),
  ...
  S3('sleet-storm', 'Sleet Storm', 'Conjuration', ['druid', 'sorcerer', 'wizard'],
    ...
    { combat: true, castKind: 'save', save: 'dex', concentration: true, range: '150ft', area: 'trụ tròn bán kính 20ft, cao 40ft',
...
// 2014 ↔ 2024 names: search and PDF import accept either.
...
for (const d of SRD_SPELLS) if (SPELL_ALIASES[d.id]) d.aliases = SPELL_ALIASES[d.id];
